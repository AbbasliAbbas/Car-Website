  ...
  return (
    <div className='bg-[#123456] h-[100px]'>
        <header className='flex '>
            <img src="./src/assets/images/logo.png" alt="" className='rounded-[10px] w-[80px] h-[80px] mt-[10px] mr-[300px] ml-[30px]' />
            <nav className='sticky'>
                <ul className='flex gap-[50px] text-gray-400 hover:text-[white] pt-[35px] mr-[200px]'>
                    <li className='text-gray-400 hover:text-[white] '><a href="Home">Home</a></li>
                    ...
                    <li className='text-gray-400 hover:text-[white] '><a href="">Services</a></li>
                    <li className='text-gray-400 hover:text-[white] '><a href="">Contact</a></li>
                </ul>
            </nav>
